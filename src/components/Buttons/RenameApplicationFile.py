...
from src.components.Modais.RenameApplicationFile import RenameAppFile

class RenameApplicationFile(ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        await interaction.response.send_modal(RenameAppFile(self.app_id, self.path, self.file_data))
