...
from src.components.LayoutView.Database.LayoutSnapshotDatabase import LayoutSnapshotDownload

MAX_DISCORD_FILE = 10 * 1024 * 1024

class CreateDatabaseSnapshot(ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        req = await squarecloud_request.create_database_snapshot(app_id)
